 ...
 * @author ASAD
 */
public class ChangeEmpPass extends javax.swing.JFrame {

    GetterSetter gs=null;
    public ChangeEmpPass(GetterSetter gs)
    {
      this.gs=gs;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String name1=gs.getName();
        String old_Pswrd=jTextField1.getText();
        String new_Pswrd=jTextField2.getText();
        String cnfrm_Pswrd=jTextField3.getText();
        int i=DbOperation.updateEmpPassword(old_Pswrd,new_Pswrd,cnfrm_Pswrd,name1);
        if(i>0)
        {
        ...
        {
        {
            JOptionPane.showMessageDialog(rootPane, "Password Not Update ");
        }
        }
