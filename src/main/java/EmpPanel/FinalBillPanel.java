...
public class FinalBillPanel extends javax.swing.JFrame {
    ...
    public FinalBillPanel(HashMap<String,ArrayList> hm,GetterSetter gs) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr No", "Item Id", "Item Name", "Item Price", "Item Quantity"
            }
        ) {
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
       ...
       String phn1= jTextField1.getText();
       
       
        ResultSet rs= DbOperation.customerDetails(phn1);
        try
        {
        if(rs.next())
        {
        jTextField2.setText(rs.getString("Cust_Name"));
        jTextField3.setText(rs.getString("Cust_Email"));
        }
        else
        {
        jTextField2.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println("Getetetename"+gs.getName());
        String mblNumber=jTextField1.getText();
        String Custname=jTextField2.getText();
        String CustEmail=jTextField3.getText();
        String totalBill=jLabel3.getText();
        
       new PaymentPanel(totalBill,mblNumber, Custname, CustEmail, hm,gs).setVisible(true);
        setVisible(false);
